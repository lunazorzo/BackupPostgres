...
//http://www.guj.com.br/t/backup-e-restore-bd-postgres-8-4-usando-java/130101/5
    ...
    public static void realizaBackup() throws IOException, InterruptedException {
        ...
        comandos.add("C:\\Backup_Postgres\\teste.backup");   // eu utilizei meu C:\ e D:\ para os testes e gravei o backup com sucesso.  
        comandos.add("Demo");
    ...
    private static void VerificaArquivo() {
        File arquivo = new File("C:\\Backup_Postgres\\teste.backup");
        if (arquivo.exists()) {
            JOptionPane.showMessageDialog(null, "Backup realizado com sucesso!");
